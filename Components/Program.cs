...
//                Console.WriteLine("bitMultiDemux bug");
            ...
            if (!halfAdder.TestGate())
                Console.WriteLine("halfAdder bug");

            FullAdder fullAdder = new FullAdder();
            if (!fullAdder.TestGate())
                Console.WriteLine("fullAdder bug");
...
//                Console.WriteLine("bitMultiDemux corr bug");
            ...
            if (halfAdder.TestGate())
                Console.WriteLine("halfAdder corr bug");

            if (fullAdder.TestGate())
                Console.WriteLine("fullAdder corr bug");

            if (multiBitAdder.TestGate())
                Console.WriteLine("multiBitAdder corr bug");

            if (alu.TestGate())
                Console.WriteLine("alu corr bug");
