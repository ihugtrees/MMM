...
namespace Assembler
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a.TranslateAssemblyFile(@"D:\BGU-PC\MMM\MMM\Ex2.3\Code\AssemblyExamples\SquareMacro.asm"
                ,@"D:\BGU-PC\MMM\MMM\Ex2.3\Code\AssemblyExamples\AsmOutput\SquareMacro.mc");
        }
    }
}